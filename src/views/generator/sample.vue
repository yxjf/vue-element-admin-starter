              ...
              <el-col :span="21">
                <el-form :inline="true" :model="queryParams" size="small">
                  ...
                  <el-form-item label="内容">
                    <el-input type="text" v-model="queryParams.description" placeholder="请输入内容关键字"></el-input>
                  </el-form-item>
                  <el-form-item label="日期">
                    <el-date-picker type="daterange" v-model="queryParams.date"
        ...
        <el-form ref="detailForm" :model="detail" label-width="120px" class="detail-form">
          <el-row>
            <el-col :span="24">
              ...
              <el-form-item label="日期">
                {{ detail.date | datetime('YYYY-MM-DD') }}
              </el-form-item>
              <el-form-item label="状态">
                {{ detail.status === 1 ? '是' : '否' }}
              </el-form-item>
              <el-form-item label="数量">
                {{ detail.amount | thousand }}
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
