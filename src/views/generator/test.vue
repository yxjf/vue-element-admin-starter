  ...
  <div>
    <tab-container ref="tabContainer"
      ...
      <template slot="default">
        <data-table ref="dateTable"
              ...
              <el-col :span="21">
                <el-form :inline="true" :model="queryParams" size="small">
                  ...
                  <el-form-item label="标题">
                    <el-input type="text" v-model="queryParams.title" placeholder="请输入标题关键字"></el-input>
                  </el-form-item>
                  <el-form-item label="状态">
                    <el-select v-model="queryParams.status" placeholder="请选择状态" :multiple="false">
                  ...
                  <el-form-item label="更新日期">
                    <el-date-picker type="daterange" v-model="queryParams.updateTime"
          ...
          <template slot="columns">
            ...
            <el-table-column prop="status" label="状态" align="center" width="120" sortable="custom">
              <template slot-scope="scope">
                {{ scope.row.status === 1 ? '是' : '否' }}
              </template>
            </el-table-column>
            <el-table-column prop="updateTime" label="更新日期" align="center" width="100" sortable="custom">
              <template slot-scope="scope">
      ...
      <template slot="editTab">
        <!--编辑表单 TODO 根据需要修改-->
        <el-form ref="editForm" :model="form" :rules="formRules" label-width="120px" class="edit-form">
